...
describe('OpenCode Client', () => {
  ...
  describe('Chat', () => {
    ...
    it('should handle productivity mode prompt', async () => {
      ...
      const messages: ChatMessage[] = [
        {
          role: 'system',
          content: 'You are a personal productivity assistant. Keep responses brief and actionable.',
        },
        {
          role: 'user',
          content: 'I have 3 meetings today and 5 Jira tickets assigned. What should I prioritize?',
        },
      ];
  ...
  describe('Token Estimation', () => {
    it('should estimate tokens for messages', () => {
      ...
      const tokens = opencodeClient.estimateTokens(messages);
